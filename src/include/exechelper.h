...
#define EXECHELP_LD_PRELOAD_PATH          "/usr/local/lib/firejail/libexechelper.so:/usr/local/lib/firejail/libexechelperdecorations.so"
#define EXECHELP_LD_PRELOAD_DECO_ONLY     "/usr/local/lib/firejail/libexechelperdecorations.so"
